        ...
        if (password !== confirmPassword) {
            ...
            try {
                if (SYSTEM_CONFIG.USE_MOCK_API || !SYSTEM_CONFIG.BASE_API_URL) {
                    ...
                    toast.dismiss();
                    toast.success("Registration successful with Firebase!", {
                        autoClose: 3000,
                    ...
                    const response = await axios.post(
                        `${SYSTEM_CONFIG.BASE_API_URL}/api/auth/register`,
                        user
                    );
    ...
    const handleGoogleSignUp = async () => {
        ...
        try {
            ...
            if (SYSTEM_CONFIG.USE_MOCK_API || !SYSTEM_CONFIG.BASE_API_URL) {
                ...
                const response = await axios.post(`${SYSTEM_CONFIG.BASE_API_URL}/api/auth/google`, {
                    email: user.email,
